...
export default class TypedTransition {
    ...
    logRouteInfo(route) {
        ...
        Logger.logDebug('TypedTransition', `Route size: ${currentRoutes.length}; Current Routes: ${JSON.stringify(currentRoutes.map((route) => route.path))}; New Route: ${JSON.stringify({path: route.path})}`);
    }
