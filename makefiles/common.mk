...
emulator_apk_path := $(apk_path)/app-x86-release.apk
emulator_apk_path_universal := $(apk_path)/app-release.apk
universal_apk_path := $(apk_path)/app-release.apk
arm_64_apk_path := $(apk_path)/app-arm64-v8a-release.apk
